...
const Maquillaje = ({ allProducts, setAllProducts, countProducts, setCountProducts, total, setTotal, categoria }) => {

    const makeupProducts = categoria === 'Maquillaje' ? data.filter(product => product.categoria.nombre === 'Maquillaje') : [];
