...
const CuidadoFacial = ({ allProducts, setAllProducts, countProducts, setCountProducts, total, setTotal, categoria }) => {
    console.log('Categoria recibida:', categoria);

    const facialProducts = categoria === 'Cuidado-Facial' ? data.filter(product => product.categoria.nombre === 'Cuidado-Facial') : [];
