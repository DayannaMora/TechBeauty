...
const CuidadoCorporal = ({ allProducts, setAllProducts, countProducts, setCountProducts, total, setTotal, categoria }) => {

    console.log('Categoria recibida:', categoria);

    const bodyProducts = categoria === 'Cuidado-Corporal' ? data.filter(product => product.categoria.nombre === 'Cuidado-Corporal') : [];
